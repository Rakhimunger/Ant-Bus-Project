...
//   // Define outside your component or in a shared config file
...
//                 {/* Bus Hire Dropdown */}
//                 <div className="relative px-3 py-2 cursor-pointer select-none">
//                   <div
//                     onClick={handleDropdownToggle}
//                     className="flex items-center space-x-2 text-gray-600 hover:text-[#3B4B96] transition-colors"
//                   >
...
//                   {isDropdownOpen && (
//                     <div className="absolute top-full left-0 mt-1 w-64 bg-white shadow-lg rounded-md z-50">
