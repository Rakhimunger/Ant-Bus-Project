  ...
  return (
    <div className="text-gray-800 relative">
      ...
      <div className="relative w-full h-[20vh] sm:h-[70vh]">
        ...
        {/* Centered Content - moved further up */}
        <div className="absolute inset-0 flex flex-col justify-start items-center text-white px-2 sm:px-6 text-center space-y-2 sm:space-y-5 z-10 pt-1 sm:pt-6">
